...
if not DEBUG:
    ...
    # AWS S3 Settings - Only enable if bucket name is set
    ...
    if AWS_STORAGE_BUCKET_NAME:
        ...
        # In eu-north-1, the region-specific endpoint is safer
        ...
        # Fallback to local media in production if no S3 configured
        MEDIA_URL = '/media/'
